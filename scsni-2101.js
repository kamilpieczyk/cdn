...
`},6435:function(t,e,i){var o=this&&this.__decorate||function(t,e,i,o){var r,s=arguments.length,n=s<3?e:null===o?o=Object.getOwnPropertyDescriptor(e,i):o;if("object"==typeof Reflect&&"function"==typeof Reflect.decorate)n=Reflect.decorate(t,e,i,o);else for(var l=t.length-1;l>=0;l--)(r=t[l])&&(n=(s<3?r(n):s>3?r(e,i,n):r(e,i))||n);return s>3&&n&&Object.defineProperty(e,i,n),n};Object.defineProperty(e,"__esModule",{value:!0}),e.PlpFilterContainer=void 0;const r=i(4546),s=i(5581),n=i(9657),l=i(6507),a=i(3204),c=i(4626),d=i(3740),h=i(6731),u=i(8334),p=i(386),f=i(4849),v=i(3538),y=i(8718),g=i(1227),m=i(6432),_=i(2069),b=i(5910);let $=class extends((0,n.SignalWatcher)(r.LitElement)){constructor(){super(...arguments),this.handleClearAllBtn=async()=>{const t=document.querySelector(".reset.filter-options__reset");t.click(),document.querySelector(".veil")||b.default.on(),await new Promise((t=>{setInterval((()=>{document.querySelector(".veil")||t(!0)}),100)})),u.default.value=t.href,p.default.value=document;const e=new h.default;a.default.value=e.numberOfResults,f.default.value=e.sidebarTitle,v.default.value=e.sortOptions,d.default.value=e.filters,y.default.value=e.selectedSorting,(0,_.updateSelectedFilters)(e.filters)},this.handleOpenFiltersSidebar=()=>{window.scrollY<200&&window.scrollTo({top:200,behavior:"smooth"}),c.default.value=!0}}static{this.styles=l.default}get selectedFilters(){let t=[];for(let e of d.default.value){const i=e.filters.filter((t=>t.isChecked));i.length>0&&i.forEach((i=>{t.push({name:e.name,value:i.title})}))}return t}render(){return r.html`
      <div class="plp-filter-btn-box">
        <dy-button @click=${this.handleOpenFiltersSidebar}>
          <dy-icon icon="filter"></dy-icon>
          <span>Filter & Sort</span>
          ${_.default.value.length>0?r.html`<div class="filters-count">${_.default.value.length}</div>`:r.nothing}
        </dy-button>
      ...
      ${_.default.value.length>0?r.html`
          <div class="plp-filters-box ${g.default.value&&!m.default.value?"plp-filters-box-hidden":""}">
            ${_.default.value.map((t=>r.html`
                <plp-filter
                  name="${t.category}"
                  value="${t.title}"
                ></plp-filter>
